...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", 
    ...
    if 'llava' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            # check if vision tower is siglip2 naflex
            if "naflex" in model_path.lower():
                cfg.mm_use_siglip = False
                cfg.mm_use_siglip2 = True
                cfg.mm_use_siglip2_naflex = True
            ...
            elif "qwen2" in model_path.lower() or "qwen_2" in model_path.lower():
                model = LlavaQwen2ForCausalLM.from_pretrained(
                    model_path,
                    low_cpu_mem_usage=True,
                    **kwargs
            )
            elif "qwen3" in model_path.lower() or "qwen_3" in model_path.lower():
